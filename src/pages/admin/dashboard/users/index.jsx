    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `https://backend-app-ticketing-v12-production-7d84.up.railway.app/v1/api/users`,
          {
            method: "GET",
            headers: {
                    ...
                    <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          {userData && userData.data && userData.data.map((users) => (
                            <tr key={users.id} className="bg-white">
                              ...
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                <span className="font-medium text-gray-500">{users.email}</span>
                              </td>
                              ...
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                              <span className="font-medium text-gray-500">{users.alamat}</span>
                              </td>
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                              <span className="font-medium text-gray-500">{users.nomor_telepon}</span>
                              </td>
                            </tr>
                          ))}
                        </tbody>
