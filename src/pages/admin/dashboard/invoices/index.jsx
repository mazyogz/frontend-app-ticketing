    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `https://backend-app-ticketing-v12-production-7d84.up.railway.app/v1/api/admin/invoice`,
          {
            method: "GET",
            headers: {
                    ...
                    <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          {invoiceData && invoiceData.data && invoiceData.data.map((users) => (
                            <tr key={users.id} className="bg-white">
                              ...
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                                <span className="font-medium text-gray-500">{users.nama_lengkap}</span>
                              </td>
                              ...
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                              <span className="font-medium text-gray-500">{users.invoice_code}</span>
                              </td>
                              <td className="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                              <span className="font-medium text-gray-500">{users.order_id}</span>
                              </td>
                            </tr>
                          ))}
                        </tbody>
