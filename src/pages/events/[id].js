        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-2 border-b border-gray-200 pb-5 text-sm sm:flex sm:justify-between">
            <dl className="flex">
              ...
              <dd className="font-medium text-gray-900">{eventDetail.data.eventData.id}</dd>
              <dt>
              ...
              <div className="grid grid-cols-1 text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-8">
                ...
                <div className="sm:col-span-12 md:col-span-7">
                  <dl className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-4 sm:grid-cols-2 sm:gap-x-6 sm:py-4 md:py-4">
                    <div>
                      <dt className="font-medium text-gray-900">Waktu dan Tempat</dt>
                      <dd className="mt-3 text-gray-500">
                        <span className="block">{eventDetail.data.eventData.venue}</span>
                        <span className="block">{eventDetail.data.eventData.jam_mulai} - Selesai</span>
                        <span className="block">{formatDate(eventDetail.data.eventData.date)}</span>
                      </dd>
                    </div>
                  </dl>
            ...
            {eventDetail.data.ticketData.map((ticket) => (
              <div key={ticket.id}>
                <button
                  ...
                  className="overflow-hidden rounded-lg bg-white shadow w-full"
                >
                  <div className="p-5">
                ...
                {isModalOpen && selectedTicketId === ticket.id && (
                  <div
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Pemesanan tiket konser {eventDetail.data.eventData.event_name} berhasil
